...
\begin{abstract}
	Der Bereich des Online-Spiels erfreut sich coronabedingt immer größerer Beliebtheit. Dies könnte vor allem aus der unkomplizierten Zugangsmöglichkeit resultieren, aber auch der sich als redundant erweisenden Softwareinstallation. Damals wurden 
	diese Art von Games mit Adobes Software 'Flash' realisiert. Aufgrund der Risiken auf der Sicherheitsebene wurde die Unterstützung der Software eingestellt. Heutzutage bedient man sich verschiedener Webtechnologien, die im Kapitel IV näher beleuchtet werden.
...
Das Spielprinzip soll als Vorlage für das zu entwickelnde Online-Multiplayer-Spiel ``Explosion Guy'' dienen. 
...
Da ''Cheating'' eine große Problematik, insbesondere beim Multiplayer-Spiel darstellt, werden alle empfangenen Daten auf dem Server validiert. Dies löst zwar das Problem nicht vollständig, sollte jedoch kleine Angriffe abwehren. 
\begin{figure}[H]
    \centering
