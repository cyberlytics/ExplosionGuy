...
% Spielstatus selbst wird nicht in einer DB gespeichert, eher in einem Objekt gehalten.
...
% Die Buckets können Container enthalten.
...
Die Game Engine, 
% HTML5 ist doch nicht die Gameengine?
...
%haben wir vom Spiel generierte Enemys? Ich würde das auf Multiplayer beschränken
